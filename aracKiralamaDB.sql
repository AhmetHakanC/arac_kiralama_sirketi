...
DELIMITER //
CREATE FUNCTION calculateTotalCost(startDate DATE, endDate DATE, cost INT)
    RETURNS INT
    DETERMINISTIC
    NO SQL
BEGIN
...
BEGIN
    ...
    INSERT INTO kiralama_islemleri(arac_id, musteri_id, personel_id, kiralama_tarihi, teslim_tarihi, toplam_fiyat,
                                   odeme_tur)
...
BEGIN
    ...
    VALUES (aracMarka, aracModel, aracYil, aracRenk, aracImageUrl, aracPlaka, aracFiyat, aracYakit, aracVites,
            aracKilometre, 0);
END //
DELIMITER ;
