...
export function ShowPage() {
    ...
    return (
        <Layout>
            ...
            <div className="w-full h-screen justify-center flex p-6">
                <div className="w-2/5">
                    <img src={'https://i.im.ge/2024/06/01/Ki8X0Y.car-1.md.png'} className="object-cover" alt={"Arac"}/>
                </div>
                <div className="w-3/5 flex flex-col space-y-2 p-4">
